            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="space-x-3">
                            <a href="{{ route('user.bookings.create') }}?training_id={{ $training->id }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                Забронировать
                            </a>
                            <a href="{{ route('user.trainings.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                                Назад к списку
                            </a>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <dl class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900 text-green-600 font-semibold">{{ number_format($training->price, 2) }} ₽</dd>
                                </div>
                                <div>
