            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="space-x-3">
                            <a href="{{ route('manager.bookings.edit', $booking) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                                Редактировать
                            </a>
                            <a href="{{ route('manager.bookings.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                                Назад к списку
                            </a>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <dl class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900">{{ $booking->user->phone ?: 'Не указан' }}</dd>
                                </div>
                            </dl>
                        </div>
                        ...
                        <div>
                            ...
                            <dl class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900">{{ number_format($booking->training->price, 2) }} ₽</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
