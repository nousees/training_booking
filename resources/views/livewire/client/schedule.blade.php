<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6 text-center">
        ...
        <p class="text-sm text-gray-500 mt-1">Ваши предстоящие тренировки на ближайшую неделю</p>
    </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full mx-4 p-6">
                <div class="flex items-start justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">Информация о тренировке</h3>
